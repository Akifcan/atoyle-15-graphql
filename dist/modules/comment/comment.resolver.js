...
exports.commentResolvers = {
    commentReplies: (props, context) => __awaiter(void 0, void 0, void 0, function* () {
        (0, helpers_1.authGuard)(context.headers.authorization);
        const { id } = props;
        console.log(id);
        const comments = yield db_postgres_1.default.client.query(`
    ...
    postComments: (props, context) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      `, [id]);
        ...
        console.log((0, comment_transformer_1.commentsToPublicEntity)(comment));
        return (0, comment_transformer_1.commentsToPublicEntity)(comment);
    }),
