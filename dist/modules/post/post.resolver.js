...
exports.postResolvers = {
    post: (props, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    create: (props, context) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const query = yield db_postgres_1.default.client.query('INSERT INTO post (employeeid, content) VALUES ($1, $2) RETURNING id;', [currentUser.id, content]);
            const { id } = query.rows[0];
            const post = yield db_postgres_1.default.client.query('SELECT * FROM post where id = $1', [
                id
            ]);
            return post.rows[0];
        }
