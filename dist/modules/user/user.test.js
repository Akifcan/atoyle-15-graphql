...
describe('Test the root path', () => {
  ...
  test('It should return profile props', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield user_resolver_1.userResolvers.profile(
        { slug: 'akif-kara' },
        { headers: { authorization: test_1.MOCK_JWT } }
      )
  ...
  test('It should throw error if profile does not found', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        yield user_resolver_1.userResolvers.profile(
          { slug: 'asdfasdfasdf' },
          { headers: { authorization: test_1.MOCK_JWT } }
        )
        expect(true).toBe(false)
  ...
  test('It should throw error if no jwt provided', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        yield user_resolver_1.userResolvers.profile(
          { slug: 'asdfasdfasdf' },
  ...
  test('It should throw error if jwt regex is wrong', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        yield user_resolver_1.userResolvers.profile(
          { slug: 'asdfasdfasdf' },
