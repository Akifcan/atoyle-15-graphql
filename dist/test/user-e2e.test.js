...
describe('Test the root path', () => {
    ...
    test('It should throw error if jwt not exists', () => __awaiter(void 0, void 0, void 0, function* () {
        const query = `
      query USER_PROFILE {
        profile(slug:"akif-kara") {
          name,
    ...
    test('It should throw error if user slug does not found', () => __awaiter(void 0, void 0, void 0, function* () {
        const query = `
      query USER_PROFILE {
